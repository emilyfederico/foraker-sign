...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Foraker Sign - Share' },
    { description: 'I just signed a document in style with Foraker Sign!' },
    {
      property: 'og:title',
      content: 'Foraker Sign - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Foraker Sign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for Foraker Sign.
  throw redirect('https://sign.foraker.ai');
};
