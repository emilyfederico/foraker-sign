...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    file: 'pa-pkt-consumers-guide.pdf',
    badge: 'PA',
    pages: 30,
    folder: 'pa-buying',
  ...
  {
    name: 'Property Description Sheet',
    file: 'pa-pkt-property-description.pdf',
    badge: 'PA',
    pages: 2,
    folder: 'pa-buying',
    desc: 'Property description sheet (PA).',
  },
  {
    name: 'Lead-Based Paint Disclosure & EPA Pamphlet',
    file: 'pa-pkt-lead-paint.pdf',
    badge: 'PA',
    pages: 21,
    folder: 'pa-buying',
    desc: 'Lead-based paint disclosure with the EPA “Protect Your Family” pamphlet.',
  },
  {
    name: "Seller's Property Disclosure Statement",
    file: 'pa-pkt-sellers-disclosure.pdf',
    badge: 'PA',
    pages: 11,
    folder: 'pa-buying',
    desc: 'PAR seller’s property disclosure statement.',
  },
  {
    name: 'Wire Fraud Notice',
    file: 'pa-pkt-wire-fraud.pdf',
    badge: 'PA',
    pages: 1,
    folder: 'pa-buying',
