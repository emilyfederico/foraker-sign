...
const TEMPLATES: Template[] = [
  ...
  {
    name: 'Standard Agreement for the Sale of Real Estate',
    file: 'pa-standard-agreement.pdf',
    badge: 'PA',
    pages: 15,
    fillable: true,
    folder: 'pa-buying',
    desc: 'PAR standard agreement of sale.',
  },
  {
    name: 'Buyer (Tenant) Agency Contract',
    file: 'pa-buyer-agency-contract.pdf',
    badge: 'PA',
    pages: 4,
    folder: 'pa-buying',
    desc: 'Exclusive buyer (tenant) agency contract.',
  },
  {
    name: "Buyer's Estimated Costs and Deposits",
    file: 'pa-buyer-estimated-costs.pdf',
    badge: 'PA',
    pages: 1,
    folder: 'pa-buying',
    desc: 'Estimated buyer costs and deposits worksheet.',
  },
  {
    name: 'Consumer Notice (PAR CN)',
    file: 'pa-consumer-notice-cn.pdf',
    badge: 'PA',
    pages: 2,
    folder: 'pa-buying',
    desc: 'PAR consumer notice — buying.',
  },
  {
    name: 'Consumer Notice (PAR CNT)',
    file: 'pa-consumer-notice-cnt.pdf',
    badge: 'PA',
    pages: 2,
    folder: 'pa-buying',
    desc: 'PAR consumer notice (transaction) — buying.',
  },
  {
    name: "Consumer's Guide to the Agreement of Sale",
    file: 'pa-consumers-guide.pdf',
    badge: 'PA',
    pages: 30,
    folder: 'pa-buying',
    desc: 'PAR consumer guide explaining the agreement of sale.',
  },
  {
    name: 'Protect Your Family From Lead',
    file: 'pa-protect-from-lead.pdf',
    badge: 'PA',
    pages: 19,
    folder: 'pa-buying',
    desc: 'EPA lead-based paint pamphlet.',
  },
  {
    name: 'Wire Fraud Notice (PAR WFN)',
    file: 'pa-wire-fraud-notice.pdf',
    badge: 'PA',
    pages: 1,
    folder: 'pa-buying',
    desc: 'Wire fraud advisory notice.',
  },
  {
  ...
  {
    name: 'Cecil County Hazardous Waste Sites',
  ...
  },
  {
    ...
    pages: 513,
    folder: 'lease',
    desc: 'Maryland tenant/renters’ disclosures — renters’ rights, tenants’ bill of rights (multi-language). Parked in Lease — tell me the right folder.',
  },
  {
